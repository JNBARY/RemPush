...
final class RemPushCoreTests: XCTestCase {
    ...
    func testPushRequestUsesPageTitle() throws {
        ...
        XCTAssertEqual(scheduler.requests, [.init(title: "Push mich", body: "RemPush Gedankenstütze", pageIndex: 0)])
    }
    ...
    func testPushRequestFallsBackWhenTitleIsEmptyAndRequiresScheduler() throws {
        ...
        XCTAssertEqual(try storeWithoutScheduler.notificationRequest(pageIndex: 1), .init(title: "RemPush Seite 2", body: "RemPush Gedankenstütze", pageIndex: 1))
